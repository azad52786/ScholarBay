...
const CartSectionHome = () => {
  const { totalPrice, cartItems, totalItems } = useSelector(
    (store) => store.Cart
  );
  ...
  return (
    <div className=" w-full h-full mb-10 font-mono">
      <div className=" w-[90%] md:w-[70%] h-full mx-auto mt-5">
        <p className=" font-mono text-3xl font-medium text-richblack-25 mb-6">
          Cart
        </p>
        <div className=" flex flex-col justify-center items-start gap-y-3 mb-4">
          <div className=" w-full flex items-center justify-between">
            <p className="text-lg text-pure-greys-200 mb-[-10px]">
        ...
        {cartItems && cartItems.length <= 0 && (
          <p className=" text-center text-2xl font-bold" style={style}>
