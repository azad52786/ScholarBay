...
exports.createCourse = async (req , res) => {
    try{
        const { course , courseDescription , whatYouWillLearn , price , tag , category} = req.body;
        ...
        const cloudinaryImage = await cloudinaryImageUploader(thumbnail , process.env.FOLDER_NAME);
